...
export const FeaturedCard = ({ item, onPress }: FeaturedCardProps) => {
  return (
    ...
    >
      ...
      <View className="flex flex-col items-start absolute bottom-5 px-5">
        <Text
        ...
        <Text
          className="text-base font-rubik-medium text-white"
          numberOfLines={1}
        >
          {item.address}
        </Text>
        ...
        <View className="flex flex-row items-center justify-between w-full">
          <Text className="text-md font-rubik-medium text-white">
            {" "}
            ${item.price}
          </Text>
